...
class UnifiedExperimentResults:
    ...
    # TFLite eval on test set
    tflite_test_mAP50: float = 0.0
    tflite_test_mAP50_95: float = 0.0
    tflite_test_precision: float = 0.0
    tflite_test_recall: float = 0.0
    tflite_test_f1: float = 0.0
    tflite_test_per_class_ap50: Dict[str, float] = field(default_factory=dict)
    # framework inference
